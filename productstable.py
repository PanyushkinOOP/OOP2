...
class productsTable(dbTableWidget):
  ...
  def update(self):
    ...
    for a in self._store.getProductCodes():
      self.setItem(r,0,QtWidgets.QTableWidgetItem(self._store.getProductName(a)))
      self.setItem(r,1,QtWidgets.QTableWidgetItem(self._store.getProductType(a)))
      self.setItem(r,2,QtWidgets.QTableWidgetItem(self._store.getProductMaterialCode(a)))
