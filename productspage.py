class productspage:
    ...
    def index(self):
        ...
        for c in self.__sto.getProductCodes():
            ...
            s+='<td>%s</td>'%self.__sto.getProductType(c)
    ...
    def productform(self,code=0,add=True):
        ...
        if code in self.__sto.getProductCodes():
            ...
            typel=self.__sto.getProductType(code)
        ...
        s = '''<form action=%s method=post>
             <table>
                ...
                <tr><td>%s</td><td><input type=text name=type value='%s'></td></tr>
    ...
    def addaction(self,name,typel,material,weight,price):
        ...
        self.__sto.setProductType(code,typel)
        self.__sto.setProdcutMaterial(code,int(material))
    ...
    def editaction(self,code,name,typel,material,weight,price):
        ...
        self.__sto.setProductType(int(code),typel)
